 ...
 */
package com.work.petclinic.aop;
...
public class LoggingAspectAnnotationDriven {
	...
	@Before("execution(* com.work.petclinic.web.GeneralController.handleException(..))")
	...
	@After("execution(* com.work.petclinic.web.GeneralController.handleException(..))")
	...
	@Before("execution(* com.work.petclinic.config.MultiHttpSecurityConfig.*.*(..))")
	...
	@Before("execution(* com.work.petclinic.SampleWebUiApplication.*(..))")
	...
	@After("execution(* com.work.petclinic.SampleWebUiApplication.*(..))")
	...
	@Before("execution(* com.work.petclinic.service.ClinicServiceImpl.*(..))")
	...
	@After("execution(* com.work.petclinic.service.ClinicServiceImpl.*(..))")
